    ...
    <Transition.Root show={open} as={Fragment}>
      <Dialog as="div" className="relative z-10" onClose={setOpen}>
        ...
        <div className="fixed z-10 inset-0 overflow-y-auto">
          <div className="flex items-stretch sm:items-center justify-center min-h-full text-center sm:px-6 lg:px-8">
            <Transition.Child
              as={Fragment}
              enter="ease-out duration-300"
            ...
            >
              <Dialog.Panel className="flex text-base text-left transform transition w-full max-w-3xl sm:my-8">
